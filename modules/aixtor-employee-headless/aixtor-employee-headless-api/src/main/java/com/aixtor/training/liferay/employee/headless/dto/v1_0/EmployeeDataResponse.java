 ...
 */
@Generated("")
@GraphQLName("EmployeeDataResponse")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "EmployeeDataResponse")
public class EmployeeDataResponse implements Serializable {

	public static EmployeeDataResponse toDTO(String json) {
		return ObjectMapperUtil.readValue(EmployeeDataResponse.class, json);
	}

	public static EmployeeDataResponse unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(
			EmployeeDataResponse.class, json);
	}

	@Schema(description = "The Branch Details")
	@Valid
	...
	public void setBranchs(
		UnsafeSupplier<Branch[], Exception> branchsUnsafeSupplier) {

		try {
			branchs = branchsUnsafeSupplier.get();
		}
	...
	@GraphQLField(description = "The Branch Details")
	...
	public boolean equals(Object object) {
		...
		if (!(object instanceof EmployeeDataResponse)) {
			return false;
		}

		EmployeeDataResponse employeeDataResponse =
			(EmployeeDataResponse)object;

		return Objects.equals(toString(), employeeDataResponse.toString());
	}
	...
	public String toString() {
		...
		if (branchs != null) {
			...
			for (int i = 0; i < branchs.length; i++) {
				sb.append(String.valueOf(branchs[i]));
	...
	@Schema(
		...
		defaultValue = "com.aixtor.training.liferay.employee.headless.dto.v1_0.EmployeeDataResponse",
		name = "x-class-name"
	)

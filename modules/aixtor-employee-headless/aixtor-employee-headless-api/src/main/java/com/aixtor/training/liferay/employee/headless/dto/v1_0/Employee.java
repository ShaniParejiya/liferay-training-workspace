 ...
 */
@Generated("")
@GraphQLName(description = "The employee Details", value = "Employee")
...
public class Employee implements Serializable {
	...
	@Schema(description = "Branch Name from employee")
	...
	@GraphQLField(description = "Branch Name from employee")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	protected String branchName;

	@Schema(description = "Department Name from employee")
	...
	@GraphQLField(description = "Department Name from employee")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	protected String departmentName;

	@Schema(description = "Designation Name from Employee")
	...
	@GraphQLField(description = "Designation Name from Employee")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	protected String designationName;

	@Schema(description = "email address from employee")
	...
	@GraphQLField(description = "email address from employee")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	protected String email;

	@Schema(description = "The employee Id from employee")
	...
	@GraphQLField(description = "The employee Id from employee")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	protected Long employeeId;

	@Schema(description = "The employee name from employee")
	...
	public void setEmployeeName(
		UnsafeSupplier<String, Exception> employeeNameUnsafeSupplier) {

		try {
			employeeName = employeeNameUnsafeSupplier.get();
		}
		catch (RuntimeException re) {
			throw re;
		}
	...
	@GraphQLField(description = "The employee name from employee")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	protected String employeeName;

	@Schema(description = "The mobile Number from employee")
	...
	@GraphQLField(description = "The mobile Number from employee")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	...
	public String toString() {
		...
		if (employeeName != null) {
			...
			sb.append(_escape(employeeName));
	...
	@Schema(
		...
		defaultValue = "com.aixtor.training.liferay.employee.headless.dto.v1_0.Employee",
		name = "x-class-name"
	)

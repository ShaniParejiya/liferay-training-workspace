 ...
 */
@Generated("")
@GraphQLName(description = "The status code of the status", value = "Status")
...
public class Status implements Serializable {
	...
	@Schema(description = "The status code of the request")
	...
	@GraphQLField(description = "The status code of the request")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	protected String code;

	@Schema(description = "The message of the request")
	...
	@GraphQLField(description = "The message of the request")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	...
	@Schema(
		...
		defaultValue = "com.aixtor.training.liferay.employee.headless.dto.v1_0.Status",
		name = "x-class-name"
	)

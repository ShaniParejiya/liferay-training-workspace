 ...
 */
@Generated("")
@GraphQLName(description = "The Branch Details", value = "Branch")
...
public class Branch implements Serializable {
	...
	@Schema(description = "branch ID from branch")
	...
	@GraphQLField(description = "branch ID from branch")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	protected Long branchId;

	@Schema(description = "branch Name from branch")
	...
	@GraphQLField(description = "branch Name from branch")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	...
	@GraphQLField(description = "branch city")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	protected String city;

	@Schema(description = "country of branch")
	...
	@GraphQLField(description = "country of branch")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	protected String country;

	@Schema(description = "state of branch")
	...
	@GraphQLField(description = "state of branch")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	...
	@Schema(
		...
		defaultValue = "com.aixtor.training.liferay.employee.headless.dto.v1_0.Branch",
		name = "x-class-name"
	)

...
import com.aixtor.training.liferay.employee.service.builder.model.DepartmentTable;
import com.aixtor.training.liferay.employee.service.builder.model.impl.DepartmentImpl;
import com.aixtor.training.liferay.employee.service.builder.model.impl.DepartmentModelImpl;
import com.aixtor.training.liferay.employee.service.builder.service.persistence.DepartmentPersistence;
import com.aixtor.training.liferay.employee.service.builder.service.persistence.DepartmentUtil;
...
public class DepartmentPersistenceImpl
	...
	private FinderPath _finderPathFetchByGetDepartmentNameById;
	private FinderPath _finderPathCountByGetDepartmentNameById;
	...
	public Department findByGetDepartmentNameById(long departmentId)
		...
		Department department = fetchByGetDepartmentNameById(departmentId);
	 ...
	 */
	@Override
	public Department fetchByGetDepartmentNameById(long departmentId) {
		return fetchByGetDepartmentNameById(departmentId, true);
	}
	 ...
	 */
	@Override
	public Department fetchByGetDepartmentNameById(
		...
		if (useFinderCache) {
			result = finderCache.getResult(
				_finderPathFetchByGetDepartmentNameById, finderArgs, this);
		}
		...
		if (result == null) {
			...
			sb.append(_FINDER_COLUMN_GETDEPARTMENTNAMEBYID_DEPARTMENTID_2);
				...
				if (list.isEmpty()) {
					if (useFinderCache) {
						finderCache.putResult(
							_finderPathFetchByGetDepartmentNameById, finderArgs,
							list);
					}
				}
				else {
					if (list.size() > 1) {
						...
						if (_log.isWarnEnabled()) {
							...
							_log.warn(
								"DepartmentPersistenceImpl.fetchByGetDepartmentNameById(long, boolean) with parameters (" +
	 ...
	 */
	@Override
	public Department removeByGetDepartmentNameById(long departmentId)
		throws NoSuchDepartmentException {

		Department department = findByGetDepartmentNameById(departmentId);
	 ...
	 */
	@Override
	public int countByGetDepartmentNameById(long departmentId) {
		FinderPath finderPath = _finderPathCountByGetDepartmentNameById;
	...
	private static final String
		_FINDER_COLUMN_GETDEPARTMENTNAMEBYID_DEPARTMENTID_2 =
			"department.departmentId = ?";

	private FinderPath _finderPathFetchByGetDepartmentNameByName;
	private FinderPath _finderPathCountByGetDepartmentNameByName;
	...
	public Department findByGetDepartmentNameByName(String departmentName)
		...
		Department department = fetchByGetDepartmentNameByName(departmentName);
	 ...
	 */
	@Override
	public Department fetchByGetDepartmentNameByName(String departmentName) {
		return fetchByGetDepartmentNameByName(departmentName, true);
	}
	 ...
	 */
	@Override
	public Department fetchByGetDepartmentNameByName(
		...
		if (useFinderCache) {
			result = finderCache.getResult(
				_finderPathFetchByGetDepartmentNameByName, finderArgs, this);
		}
		...
		if (result == null) {
			...
			if (departmentName.isEmpty()) {
				sb.append(
					_FINDER_COLUMN_GETDEPARTMENTNAMEBYNAME_DEPARTMENTNAME_3);
			}
			else {
				bindDepartmentName = true;

				sb.append(
					_FINDER_COLUMN_GETDEPARTMENTNAMEBYNAME_DEPARTMENTNAME_2);
			}
			...
			try {
				...
				if (list.isEmpty()) {
					if (useFinderCache) {
						finderCache.putResult(
							_finderPathFetchByGetDepartmentNameByName,
							finderArgs, list);
					}
				}
				else {
					if (list.size() > 1) {
						...
						if (_log.isWarnEnabled()) {
							...
							_log.warn(
								"DepartmentPersistenceImpl.fetchByGetDepartmentNameByName(String, boolean) with parameters (" +
									StringUtil.merge(finderArgs) +
										") yields a result set with more than 1 result. This violates the logical unique restriction. There is no order guarantee on which result is returned by this finder.");
						}
					}
	 ...
	 */
	@Override
	public Department removeByGetDepartmentNameByName(String departmentName)
		throws NoSuchDepartmentException {

		Department department = findByGetDepartmentNameByName(departmentName);
	 ...
	 */
	@Override
	public int countByGetDepartmentNameByName(String departmentName) {
		departmentName = Objects.toString(departmentName, "");

		FinderPath finderPath = _finderPathCountByGetDepartmentNameByName;
	...
	public void cacheResult(Department department) {
		...
		finderCache.putResult(
			_finderPathFetchByGetDepartmentNameById,
	...
	protected void cacheUniqueFindersCache(
		...
		Object[] args = new Object[] {departmentModelImpl.getDepartmentId()};

		finderCache.putResult(
			_finderPathCountByGetDepartmentNameById, args, Long.valueOf(1));
		finderCache.putResult(
			_finderPathFetchByGetDepartmentNameById, args, departmentModelImpl);

		args = new Object[] {departmentModelImpl.getDepartmentName()};

		finderCache.putResult(
			_finderPathCountByGetDepartmentNameByName, args, Long.valueOf(1));
		finderCache.putResult(
			_finderPathFetchByGetDepartmentNameByName, args,
			departmentModelImpl);
	}
	...
	public void activate() {
		...
		_finderPathFetchByGetDepartmentNameById = new FinderPath(
			FINDER_CLASS_NAME_ENTITY, "fetchByGetDepartmentNameById",
			new String[] {Long.class.getName()}, new String[] {"departmentId"},
			true);

		_finderPathCountByGetDepartmentNameById = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByGetDepartmentNameById", new String[] {Long.class.getName()},
			new String[] {"departmentId"}, false);

		_finderPathFetchByGetDepartmentNameByName = new FinderPath(
			FINDER_CLASS_NAME_ENTITY, "fetchByGetDepartmentNameByName",
			new String[] {String.class.getName()},
			new String[] {"departmentName"}, true);

		_finderPathCountByGetDepartmentNameByName = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByGetDepartmentNameByName",
			new String[] {String.class.getName()},

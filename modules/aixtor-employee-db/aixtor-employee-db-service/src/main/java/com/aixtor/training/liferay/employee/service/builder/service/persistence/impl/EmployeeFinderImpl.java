...
public class EmployeeFinderImpl extends EmployeeFinderBaseImpl implements EmployeeFinder {
	...
	//branch api headless task
	public List<EmployeeAllDetailsModel> getEmployeesByBranch(){
		Session session = null;
		try {
			System.out.println("inside getEmployeeByBranch");
			session = openSession();
			String sql = customSql.get(getClass(), "getEmployeesByBranch");

...
package com.aixtor.training.liferay.employee.service.builder.service.persistence.impl;
...
import com.aixtor.training.liferay.employee.service.builder.model.EmployeeTable;
import com.aixtor.training.liferay.employee.service.builder.model.impl.EmployeeImpl;
import com.aixtor.training.liferay.employee.service.builder.model.impl.EmployeeModelImpl;
import com.aixtor.training.liferay.employee.service.builder.service.persistence.EmployeePersistence;
import com.aixtor.training.liferay.employee.service.builder.service.persistence.EmployeeUtil;
import com.aixtor.training.liferay.employee.service.builder.service.persistence.impl.constants.AIXTOR_DBPersistenceConstants;
...
public class EmployeePersistenceImpl
	...
	private FinderPath _finderPathWithPaginationFindByfetchBranchId;
	private FinderPath _finderPathWithoutPaginationFindByfetchBranchId;
	private FinderPath _finderPathCountByfetchBranchId;
	 ...
	 */
	@Override
	public List<Employee> findByfetchBranchId(
		long branchId, int start, int end) {

		return findByfetchBranchId(branchId, start, end, null);
	}
	...
	public List<Employee> findByfetchBranchId(
		...
		return findByfetchBranchId(
			branchId, start, end, orderByComparator, true);
	}
	...
	public List<Employee> findByfetchBranchId(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderPath = _finderPathWithoutPaginationFindByfetchBranchId;
				finderArgs = new Object[] {branchId};
			}
		}
		else if (useFinderCache) {
			finderPath = _finderPathWithPaginationFindByfetchBranchId;
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_FETCHBRANCHID_BRANCHID_2);
	...
	public Employee findByfetchBranchId_First(
		...
		Employee employee = fetchByfetchBranchId_First(
	...
	public Employee fetchByfetchBranchId_First(
		...
		List<Employee> list = findByfetchBranchId(
			branchId, 0, 1, orderByComparator);
	...
	public Employee findByfetchBranchId_Last(
		...
		Employee employee = fetchByfetchBranchId_Last(
			branchId, orderByComparator);
	...
	public Employee fetchByfetchBranchId_Last(
		...
		int count = countByfetchBranchId(branchId);
	...
	public Employee[] findByfetchBranchId_PrevAndNext(
		...
		try {
			...
			array[0] = getByfetchBranchId_PrevAndNext(
				session, employee, branchId, orderByComparator, true);

			array[1] = employee;

			array[2] = getByfetchBranchId_PrevAndNext(
	...
	protected Employee getByfetchBranchId_PrevAndNext(
	...
	public int countByfetchBranchId(long branchId) {
		FinderPath finderPath = _finderPathCountByfetchBranchId;
	...
	private static final String _FINDER_COLUMN_FETCHBRANCHID_BRANCHID_2 =
		"employee.branchId = ?";

	private FinderPath _finderPathWithPaginationFindByFetchDepartmentId;
	private FinderPath _finderPathWithoutPaginationFindByFetchDepartmentId;
	private FinderPath _finderPathCountByFetchDepartmentId;
	...
	public List<Employee> findByFetchDepartmentId(long departmentId) {
		return findByFetchDepartmentId(
	 ...
	 */
	@Override
	public List<Employee> findByFetchDepartmentId(
		long departmentId, int start, int end) {

		return findByFetchDepartmentId(departmentId, start, end, null);
	}
	...
	public List<Employee> findByFetchDepartmentId(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderPath =
					_finderPathWithoutPaginationFindByFetchDepartmentId;
				finderArgs = new Object[] {departmentId};
			}
		}
		else if (useFinderCache) {
			finderPath = _finderPathWithPaginationFindByFetchDepartmentId;
			finderArgs = new Object[] {
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_FETCHDEPARTMENTID_DEPARTMENTID_2);
	...
	public Employee findByFetchDepartmentId_First(
		...
		Employee employee = fetchByFetchDepartmentId_First(
	...
	public Employee fetchByFetchDepartmentId_First(
		...
		List<Employee> list = findByFetchDepartmentId(
	...
	public Employee findByFetchDepartmentId_Last(
		...
		Employee employee = fetchByFetchDepartmentId_Last(
			departmentId, orderByComparator);
	...
	public Employee fetchByFetchDepartmentId_Last(
		...
		int count = countByFetchDepartmentId(departmentId);
	...
	public Employee[] findByFetchDepartmentId_PrevAndNext(
		...
		try {
			...
			array[0] = getByFetchDepartmentId_PrevAndNext(
				session, employee, departmentId, orderByComparator, true);

			array[1] = employee;

			array[2] = getByFetchDepartmentId_PrevAndNext(
	...
	protected Employee getByFetchDepartmentId_PrevAndNext(
	...
	public int countByFetchDepartmentId(long departmentId) {
		FinderPath finderPath = _finderPathCountByFetchDepartmentId;
	...
	private static final String
		_FINDER_COLUMN_FETCHDEPARTMENTID_DEPARTMENTID_2 =
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByfetchBranchId = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByfetchBranchId",
			new String[] {
		...
		_finderPathWithoutPaginationFindByfetchBranchId = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByfetchBranchId",
			new String[] {Long.class.getName()}, new String[] {"branchId"},
			true);

		_finderPathCountByfetchBranchId = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByfetchBranchId",
			new String[] {Long.class.getName()}, new String[] {"branchId"},
			false);

		_finderPathWithPaginationFindByFetchDepartmentId = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByFetchDepartmentId",
			new String[] {
				Long.class.getName(), Integer.class.getName(),
				Integer.class.getName(), OrderByComparator.class.getName()
			},
		...
		_finderPathWithoutPaginationFindByFetchDepartmentId = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findByFetchDepartmentId", new String[] {Long.class.getName()},
			new String[] {"departmentId"}, true);

		_finderPathCountByFetchDepartmentId = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByFetchDepartmentId", new String[] {Long.class.getName()},
			new String[] {"departmentId"}, false);

...
import com.aixtor.training.liferay.employee.service.builder.model.BranchModel;
...
/**
 * The base model implementation for the Branch service. Represents a row in the &quot;AIXTOR_DB_Branch&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class BranchModelImpl
	 ...
	 */
	public static final String TABLE_NAME = "AIXTOR_DB_Branch";

	public static final Object[][] TABLE_COLUMNS = {
		{"uuid_", Types.VARCHAR}, {"branchId", Types.BIGINT},
		{"branchName", Types.VARCHAR}, {"countryId", Types.BIGINT},
	...
	public static final String TABLE_SQL_CREATE =
		"create table AIXTOR_DB_Branch (uuid_ VARCHAR(75) null,branchId LONG not null primary key,branchName VARCHAR(75) null,countryId LONG,stateId LONG,cityId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null)";

	public static final String TABLE_SQL_DROP = "drop table AIXTOR_DB_Branch";

	public static final String ORDER_BY_JPQL = " ORDER BY branch.branchId ASC";

	public static final String ORDER_BY_SQL =
		" ORDER BY AIXTOR_DB_Branch.branchId ASC";
	 ...
	 */
	@Deprecated
	public static final long BRANCHNAME_COLUMN_BITMASK = 2L;
	...
	static {
		...
		attributeGetterFunctions.put("branchName", Branch::getBranchName);
		attributeSetterBiConsumers.put(
			"branchName", (BiConsumer<Branch, String>)Branch::setBranchName);
	...
	public String getOriginalBranchName() {
		return getColumnOriginalValue("branchName");
	}
	...
	public int compareTo(Branch branch) {
		...
		if (getBranchId() < branch.getBranchId()) {
			value = -1;
		}
		else if (getBranchId() > branch.getBranchId()) {
			value = 1;
		}
		else {
			value = 0;
	...
	static {
		...
		columnBitmasks.put("branchName", 4L);

		columnBitmasks.put("countryId", 8L);

		columnBitmasks.put("stateId", 16L);

		columnBitmasks.put("cityId", 32L);

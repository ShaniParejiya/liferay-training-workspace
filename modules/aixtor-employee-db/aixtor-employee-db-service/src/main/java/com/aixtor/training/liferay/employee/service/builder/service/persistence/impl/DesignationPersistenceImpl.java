...
import com.aixtor.training.liferay.employee.service.builder.model.DesignationTable;
import com.aixtor.training.liferay.employee.service.builder.model.impl.DesignationImpl;
import com.aixtor.training.liferay.employee.service.builder.model.impl.DesignationModelImpl;
import com.aixtor.training.liferay.employee.service.builder.service.persistence.DesignationPersistence;
import com.aixtor.training.liferay.employee.service.builder.service.persistence.DesignationUtil;
...
public class DesignationPersistenceImpl
	...
	private FinderPath _finderPathFetchByGetdesignationNameById;
	private FinderPath _finderPathCountByGetdesignationNameById;

	/**
	 * Returns the designation where designationId = &#63; or throws a <code>NoSuchDesignationException</code> if it could not be found.
	 *
	...
	public Designation findByGetdesignationNameById(long designationId)
		...
		Designation designation = fetchByGetdesignationNameById(designationId);
	...
	/**
	 * Returns the designation where designationId = &#63; or returns <code>null</code> if it could not be found. Uses the finder cache.
	 *
	 * @param designationId the designation ID
	 * @return the matching designation, or <code>null</code> if a matching designation could not be found
	 */
	@Override
	public Designation fetchByGetdesignationNameById(long designationId) {
		return fetchByGetdesignationNameById(designationId, true);
	}

	/**
	 * Returns the designation where designationId = &#63; or returns <code>null</code> if it could not be found, optionally using the finder cache.
	 *
	 * @param designationId the designation ID
	 * @param useFinderCache whether to use the finder cache
	 * @return the matching designation, or <code>null</code> if a matching designation could not be found
	 */
	@Override
	public Designation fetchByGetdesignationNameById(
		long designationId, boolean useFinderCache) {
		...
		if (useFinderCache) {
			result = finderCache.getResult(
				_finderPathFetchByGetdesignationNameById, finderArgs, this);
		}
		...
		if (result == null) {
			...
			sb.append(_FINDER_COLUMN_GETDESIGNATIONNAMEBYID_DESIGNATIONID_2);
				...
				if (list.isEmpty()) {
					if (useFinderCache) {
						finderCache.putResult(
							_finderPathFetchByGetdesignationNameById,
							finderArgs, list);
					}
				}
				else {
					if (list.size() > 1) {
						...
						if (_log.isWarnEnabled()) {
							...
							_log.warn(
								"DesignationPersistenceImpl.fetchByGetdesignationNameById(long, boolean) with parameters (" +
	...
	/**
	 * Removes the designation where designationId = &#63; from the database.
	 *
	 * @param designationId the designation ID
	 * @return the designation that was removed
	 */
	@Override
	public Designation removeByGetdesignationNameById(long designationId)
		throws NoSuchDesignationException {

		Designation designation = findByGetdesignationNameById(designationId);
	 ...
	 */
	@Override
	public int countByGetdesignationNameById(long designationId) {
		FinderPath finderPath = _finderPathCountByGetdesignationNameById;
	...
	private static final String
		_FINDER_COLUMN_GETDESIGNATIONNAMEBYID_DESIGNATIONID_2 =
	...
	public void cacheResult(Designation designation) {
		...
		finderCache.putResult(
			_finderPathFetchByGetdesignationNameById,
			new Object[] {designation.getDesignationId()}, designation);
	}
	...
	protected void cacheUniqueFindersCache(
		...
		Object[] args = new Object[] {designationModelImpl.getDesignationId()};

		finderCache.putResult(
			_finderPathCountByGetdesignationNameById, args, Long.valueOf(1));
		finderCache.putResult(
			_finderPathFetchByGetdesignationNameById, args,
			designationModelImpl);
	}
	...
	public void activate() {
		...
		_finderPathFetchByGetdesignationNameById = new FinderPath(
			FINDER_CLASS_NAME_ENTITY, "fetchByGetdesignationNameById",
			new String[] {Long.class.getName()}, new String[] {"designationId"},
			true);

		_finderPathCountByGetdesignationNameById = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByGetdesignationNameById",
			new String[] {Long.class.getName()}, new String[] {"designationId"},
			false);

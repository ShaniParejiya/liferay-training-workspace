...
import com.aixtor.training.liferay.employee.service.builder.model.BranchTable;
import com.aixtor.training.liferay.employee.service.builder.model.impl.BranchImpl;
import com.aixtor.training.liferay.employee.service.builder.model.impl.BranchModelImpl;
import com.aixtor.training.liferay.employee.service.builder.service.persistence.BranchPersistence;
import com.aixtor.training.liferay.employee.service.builder.service.persistence.BranchUtil;
...
public class BranchPersistenceImpl
	...
	private FinderPath _finderPathFetchByGetbranchNameById;
	private FinderPath _finderPathCountByGetbranchNameById;
	...
	public Branch findByGetbranchNameById(long branchId)
		...
		Branch branch = fetchByGetbranchNameById(branchId);
	 ...
	 */
	@Override
	public Branch fetchByGetbranchNameById(long branchId) {
		return fetchByGetbranchNameById(branchId, true);
	}
	 ...
	 */
	@Override
	public Branch fetchByGetbranchNameById(
		...
		if (useFinderCache) {
			result = finderCache.getResult(
				_finderPathFetchByGetbranchNameById, finderArgs, this);
		}
		...
		if (result == null) {
			...
			sb.append(_FINDER_COLUMN_GETBRANCHNAMEBYID_BRANCHID_2);
				...
				if (list.isEmpty()) {
					if (useFinderCache) {
						finderCache.putResult(
							_finderPathFetchByGetbranchNameById, finderArgs,
							list);
					}
				}
				else {
					if (list.size() > 1) {
						...
						if (_log.isWarnEnabled()) {
							...
							_log.warn(
								"BranchPersistenceImpl.fetchByGetbranchNameById(long, boolean) with parameters (" +
	 ...
	 */
	@Override
	public Branch removeByGetbranchNameById(long branchId)
		throws NoSuchBranchException {

		Branch branch = findByGetbranchNameById(branchId);
	 ...
	 */
	@Override
	public int countByGetbranchNameById(long branchId) {
		FinderPath finderPath = _finderPathCountByGetbranchNameById;
	...
	private static final String _FINDER_COLUMN_GETBRANCHNAMEBYID_BRANCHID_2 =
		"branch.branchId = ?";

	private FinderPath _finderPathFetchByfetchBranchNameByBranchId;
	private FinderPath _finderPathCountByfetchBranchNameByBranchId;
	...
	public Branch findByfetchBranchNameByBranchId(String branchName)
		...
		Branch branch = fetchByfetchBranchNameByBranchId(branchName);
	 ...
	 */
	@Override
	public Branch fetchByfetchBranchNameByBranchId(String branchName) {
		return fetchByfetchBranchNameByBranchId(branchName, true);
	}
	 ...
	 */
	@Override
	public Branch fetchByfetchBranchNameByBranchId(
		...
		if (useFinderCache) {
			result = finderCache.getResult(
				_finderPathFetchByfetchBranchNameByBranchId, finderArgs, this);
		}
		...
		if (result == null) {
			...
			if (branchName.isEmpty()) {
				sb.append(
					_FINDER_COLUMN_FETCHBRANCHNAMEBYBRANCHID_BRANCHNAME_3);
			}
			else {
				bindBranchName = true;

				sb.append(
					_FINDER_COLUMN_FETCHBRANCHNAMEBYBRANCHID_BRANCHNAME_2);
			}
			...
			try {
				...
				if (list.isEmpty()) {
					if (useFinderCache) {
						finderCache.putResult(
							_finderPathFetchByfetchBranchNameByBranchId,
							finderArgs, list);
					}
				}
				else {
					if (list.size() > 1) {
						...
						if (_log.isWarnEnabled()) {
							...
							_log.warn(
								"BranchPersistenceImpl.fetchByfetchBranchNameByBranchId(String, boolean) with parameters (" +
									StringUtil.merge(finderArgs) +
										") yields a result set with more than 1 result. This violates the logical unique restriction. There is no order guarantee on which result is returned by this finder.");
						}
					}
	 ...
	 */
	@Override
	public Branch removeByfetchBranchNameByBranchId(String branchName)
		throws NoSuchBranchException {

		Branch branch = findByfetchBranchNameByBranchId(branchName);
	 ...
	 */
	@Override
	public int countByfetchBranchNameByBranchId(String branchName) {
		branchName = Objects.toString(branchName, "");

		FinderPath finderPath = _finderPathCountByfetchBranchNameByBranchId;
	...
	public void cacheResult(Branch branch) {
		...
		finderCache.putResult(
			_finderPathFetchByGetbranchNameById,
			new Object[] {branch.getBranchId()}, branch);

		finderCache.putResult(
			_finderPathFetchByfetchBranchNameByBranchId,
			new Object[] {branch.getBranchName()}, branch);
	}
	...
	protected void cacheUniqueFindersCache(BranchModelImpl branchModelImpl) {
		Object[] args = new Object[] {branchModelImpl.getBranchId()};

		finderCache.putResult(
			_finderPathCountByGetbranchNameById, args, Long.valueOf(1));
		finderCache.putResult(
			_finderPathFetchByGetbranchNameById, args, branchModelImpl);

		args = new Object[] {branchModelImpl.getBranchName()};

		finderCache.putResult(
			_finderPathCountByfetchBranchNameByBranchId, args, Long.valueOf(1));
		finderCache.putResult(
			_finderPathFetchByfetchBranchNameByBranchId, args, branchModelImpl);
	}
	...
	public void activate() {
		...
		_finderPathFetchByGetbranchNameById = new FinderPath(
			FINDER_CLASS_NAME_ENTITY, "fetchByGetbranchNameById",
			new String[] {Long.class.getName()}, new String[] {"branchId"},
			true);

		_finderPathCountByGetbranchNameById = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByGetbranchNameById", new String[] {Long.class.getName()},
			new String[] {"branchId"}, false);

		_finderPathFetchByfetchBranchNameByBranchId = new FinderPath(
			FINDER_CLASS_NAME_ENTITY, "fetchByfetchBranchNameByBranchId",
			new String[] {String.class.getName()}, new String[] {"branchName"},
			true);

		_finderPathCountByfetchBranchNameByBranchId = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByfetchBranchNameByBranchId",
			new String[] {String.class.getName()}, new String[] {"branchName"},
			false);

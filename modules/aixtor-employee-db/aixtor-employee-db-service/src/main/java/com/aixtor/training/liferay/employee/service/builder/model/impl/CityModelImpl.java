...
import com.aixtor.training.liferay.employee.service.builder.model.CityModel;
...
/**
 * The base model implementation for the City service. Represents a row in the &quot;AIXTOR_DB_City&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class CityModelImpl extends BaseModelImpl<City> implements CityModel {
	 ...
	 */
	public static final String TABLE_NAME = "AIXTOR_DB_City";
	...
	public static final String TABLE_SQL_CREATE =
		"create table AIXTOR_DB_City (uuid_ VARCHAR(75) null,cityId LONG not null primary key,cityName VARCHAR(75) null,stateId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null)";

	public static final String TABLE_SQL_DROP = "drop table AIXTOR_DB_City";

	public static final String ORDER_BY_JPQL = " ORDER BY city.cityId ASC";

	public static final String ORDER_BY_SQL =
		" ORDER BY AIXTOR_DB_City.cityId ASC";
	 ...
	 */
	@Deprecated
	public static final long CITYID_COLUMN_BITMASK = 8L;
	...
	public int compareTo(City city) {
		...
		else if (getCityId() > city.getCityId()) {
			value = 1;
		}
		else {
			value = 0;
	...
	static {
		...
		columnBitmasks.put("cityName", 4L);

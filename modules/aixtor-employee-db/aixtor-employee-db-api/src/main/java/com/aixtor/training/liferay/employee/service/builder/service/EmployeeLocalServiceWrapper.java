...
public class EmployeeLocalServiceWrapper
	 ...
	 */
	@Override
	public com.aixtor.training.liferay.employee.service.builder.model.Employee
		addEmployee(
	...
	@Override
	public com.aixtor.training.liferay.employee.service.builder.model.Employee
		createEmployee(long employeeId) {
	...
	public java.util.List
		<com.aixtor.training.liferay.employee.service.builder.model.Employee>
			findByfetchBranchId(long branchId) {

		return _employeeLocalService.findByfetchBranchId(branchId);
	}

	@Override
	public java.util.List
		<com.aixtor.training.liferay.employee.service.builder.model.Employee>
			findByFetchDepartmentId(long departmentId) {

		return _employeeLocalService.findByFetchDepartmentId(departmentId);
	}

 ...
 * <code>com.aixtor.training.liferay.employee.service.builder.service.impl.DesignationLocalServiceImpl</code> and
...
public class DesignationLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.aixtor.training.liferay.employee.service.builder.service.impl.DesignationLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Designation fetchDesignationByUuidAndCompanyId(
		String uuid, long companyId) {

		return getService().fetchDesignationByUuidAndCompanyId(uuid, companyId);
	}

	public static Designation findByGetdesignationNameById(long designationId) {
		return getService().findByGetdesignationNameById(designationId);
	}
	 ...
	 */
	public static Designation getDesignationByUuidAndCompanyId(
			String uuid, long companyId)
		throws PortalException {

		return getService().getDesignationByUuidAndCompanyId(uuid, companyId);
	}

...
public interface BranchLocalService
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Branch fetchBranchByUuidAndCompanyId(String uuid, long companyId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Branch getBranchByUuidAndCompanyId(String uuid, long companyId)
		throws PortalException;

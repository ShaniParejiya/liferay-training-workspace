...
public class BranchUtil {
	 ...
	 * @throws NoSuchBranchException if a matching branch could not be found
	 */
	public static Branch findByGetbranchNameById(long branchId)
		throws com.aixtor.training.liferay.employee.service.builder.exception.
			NoSuchBranchException {

		return getPersistence().findByGetbranchNameById(branchId);
	}
	 ...
	 */
	public static Branch fetchByGetbranchNameById(long branchId) {
		return getPersistence().fetchByGetbranchNameById(branchId);
	}
	 ...
	 * @return the matching branch, or <code>null</code> if a matching branch could not be found
	 */
	public static Branch fetchByGetbranchNameById(
		long branchId, boolean useFinderCache) {

		return getPersistence().fetchByGetbranchNameById(
			branchId, useFinderCache);
	}
	 ...
	 */
	public static Branch removeByGetbranchNameById(long branchId)
		throws com.aixtor.training.liferay.employee.service.builder.exception.
			NoSuchBranchException {

		return getPersistence().removeByGetbranchNameById(branchId);
	}
	 ...
	 * @return the number of matching branches
	 */
	public static int countByGetbranchNameById(long branchId) {
		return getPersistence().countByGetbranchNameById(branchId);
	}
	 ...
	 * @throws NoSuchBranchException if a matching branch could not be found
	 */
	public static Branch findByfetchBranchNameByBranchId(String branchName)
		throws com.aixtor.training.liferay.employee.service.builder.exception.
			NoSuchBranchException {

		return getPersistence().findByfetchBranchNameByBranchId(branchName);
	}
	 ...
	 * @return the matching branch, or <code>null</code> if a matching branch could not be found
	 */
	public static Branch fetchByfetchBranchNameByBranchId(String branchName) {
		return getPersistence().fetchByfetchBranchNameByBranchId(branchName);
	}
	 ...
	 * @return the matching branch, or <code>null</code> if a matching branch could not be found
	 */
	public static Branch fetchByfetchBranchNameByBranchId(
		String branchName, boolean useFinderCache) {

		return getPersistence().fetchByfetchBranchNameByBranchId(
			branchName, useFinderCache);
	}
	 ...
	 * @return the branch that was removed
	 */
	public static Branch removeByfetchBranchNameByBranchId(String branchName)
		throws com.aixtor.training.liferay.employee.service.builder.exception.
			NoSuchBranchException {

		return getPersistence().removeByfetchBranchNameByBranchId(branchName);
	}
	 ...
	 * @return the number of matching branches
	 */
	public static int countByfetchBranchNameByBranchId(String branchName) {
		return getPersistence().countByfetchBranchNameByBranchId(branchName);
	}

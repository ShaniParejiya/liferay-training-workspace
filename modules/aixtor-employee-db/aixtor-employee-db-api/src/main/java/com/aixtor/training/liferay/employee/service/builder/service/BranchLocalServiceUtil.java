...
package com.aixtor.training.liferay.employee.service.builder.service;
 ...
 * <code>com.aixtor.training.liferay.employee.service.builder.service.impl.BranchLocalServiceImpl</code> and
...
public class BranchLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.aixtor.training.liferay.employee.service.builder.service.impl.BranchLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>com.aixtor.training.liferay.employee.service.builder.model.impl.BranchModelImpl</code>.
	 * </p>
	 *
	 * @param dynamicQuery the dynamic query
	 ...
	 */
	public static Branch fetchBranchByUuidAndCompanyId(
		String uuid, long companyId) {

		return getService().fetchBranchByUuidAndCompanyId(uuid, companyId);
	}

	public static Branch findByfetchBranchNameByBranchId(String branchName) {
		return getService().findByfetchBranchNameByBranchId(branchName);
	}

	public static Branch findByGetbranchNameById(long branchId) {
		return getService().findByGetbranchNameById(branchId);
	}
	 ...
	 */
	public static Branch getBranchByUuidAndCompanyId(
			String uuid, long companyId)
		throws PortalException {

		return getService().getBranchByUuidAndCompanyId(uuid, companyId);
	}

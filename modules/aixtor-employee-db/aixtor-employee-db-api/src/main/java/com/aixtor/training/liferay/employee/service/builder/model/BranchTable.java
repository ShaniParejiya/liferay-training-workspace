...
/**
 * The table class for the &quot;AIXTOR_DB_Branch&quot; database table.
 *
...
public class BranchTable extends BaseTable<BranchTable> {
	...
	public final Column<BranchTable, String> branchName = createColumn(
	...
	private BranchTable() {
		super("AIXTOR_DB_Branch", BranchTable::new);
	}

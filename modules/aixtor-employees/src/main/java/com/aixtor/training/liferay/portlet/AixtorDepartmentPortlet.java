...
import com.aixtor.training.liferay.constants.AixtorDepartmentConstant;
...
@Component(immediate = true, property = { "com.liferay.portlet.display-category=category.sample",
		...
		"javax.portlet.display-name=AixtorDepartment",
		"javax.portlet.init-param.template-path=/",
		"javax.portlet.init-param.view-template=/html/department/department.jsp",
		"javax.portlet.name=" + AixtorDepartmentConstant.AIXTOR_DEPARTMENT,
...
public class AixtorDepartmentPortlet extends MVCPortlet {
	...
	public void render(RenderRequest renderRequest, RenderResponse renderResponse)
		...
		renderRequest.setAttribute(AixtorDepartmentConstant.USERNAME_LIST, users);
	...
	public void processAction(ActionRequest actionRequest, ActionResponse actionResponse)
		...
		String DepartmentName = ParamUtil.getString(actionRequest, AixtorDepartmentConstant.DEPARTMENT_NAME);
		String DepartmentHead= ParamUtil.getString(actionRequest, AixtorDepartmentConstant.DEPARTMENT_HEAD);

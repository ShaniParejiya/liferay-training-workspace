...
import com.aixtor.training.liferay.employee.constants.AixtorBranchWebConstant;
import com.aixtor.training.liferay.employee.constants.AixtorDesignationWebConstant;
...
@Component(
		...
		property = {
			...
			"javax.portlet.display-name=AixtorBranchWeb",
			"javax.portlet.init-param.template-path=/",
			"javax.portlet.init-param.view-template=/html/branch/branch.jsp",
			"javax.portlet.name=" + AixtorBranchWebConstant.AIXTOR_BRANCH,
			"javax.portlet.resource-bundle=content.Language",
			"javax.portlet.security-role-ref=power-user,user"
		},
		service = Portlet.class
	)
public class AixtorBranchWebPortlet extends MVCPortlet {
	...
	public void render(RenderRequest renderRequest, RenderResponse renderResponse)
		...
		renderRequest.setAttribute(AixtorBranchWebConstant.COUNTRY_LIST, countries);

		// TODO Auto-generated method stub
		System.out.println("From Barnch");
	...
	public void serveResource(ResourceRequest resourceRequest, ResourceResponse resourceResponse)
			throws IOException, PortletException {
		String commandValue = ParamUtil.getString(resourceRequest, AixtorBranchWebConstant.COMMAND);
		if(commandValue.equals(AixtorBranchWebConstant.SEARCH_STATE_BY_COUNTRY)) {

			long countryId = ParamUtil.getLong(resourceRequest, AixtorBranchWebConstant.COUNTRY_ID);
		...
		else if(commandValue.equals(AixtorBranchWebConstant.SEARCH_CITY_BY_STATE)) {
			
			long stateId = ParamUtil.getLong(resourceRequest, AixtorBranchWebConstant.STATE_ID);
	...
	public void processAction(ActionRequest actionRequest, ActionResponse actionResponse)
		...
		String branchName = ParamUtil.getString(actionRequest,AixtorBranchWebConstant.BRANCH_NAME);
		Long countryId=ParamUtil.getLong(actionRequest, AixtorBranchWebConstant.COUNTRY_NAME);
		Long stateId = ParamUtil.getLong(actionRequest, AixtorBranchWebConstant.STATE_NAME);
		Long cityId = ParamUtil.getLong(actionRequest, AixtorBranchWebConstant.CITY_NAME);

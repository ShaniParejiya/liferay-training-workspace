...
@Component(
		...
		property = {
			...
			"javax.portlet.display-name=AixtorDesignationWeb",
			"javax.portlet.init-param.template-path=/",
			"javax.portlet.init-param.view-template=/html/designation/designation.jsp",
			"javax.portlet.name=" + AixtorDesignationWebConstant.AIXTOR_DESIGNATION,
			"javax.portlet.resource-bundle=content.Language",
			"javax.portlet.security-role-ref=power-user,user"
		},
		service = Portlet.class
	)
public class AixtorDesignationWebPortlet extends MVCPortlet{
	...
	public void render(RenderRequest renderRequest, RenderResponse renderResponse)
		...
		System.out.println("render designation ss called");
	...
	public void processAction(ActionRequest actionRequest, ActionResponse actionResponse)
		...
		String designationName = ParamUtil.getString(actionRequest, AixtorDesignationWebConstant.DESIGNATION_NAME);

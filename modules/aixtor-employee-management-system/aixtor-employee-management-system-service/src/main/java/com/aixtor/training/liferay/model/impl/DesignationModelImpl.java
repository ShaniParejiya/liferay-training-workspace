...
import com.aixtor.training.liferay.model.DesignationModel;
...
/**
 * The base model implementation for the Designation service. Represents a row in the &quot;AIXTOR_Designation&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class DesignationModelImpl
	 ...
	 */
	public static final String TABLE_NAME = "AIXTOR_Designation";

	public static final Object[][] TABLE_COLUMNS = {
		{"uuid_", Types.VARCHAR}, {"designationId", Types.BIGINT},
		{"designationName", Types.VARCHAR}, {"companyId", Types.BIGINT},
	...
	public static final String TABLE_SQL_CREATE =
		"create table AIXTOR_Designation (uuid_ VARCHAR(75) null,designationId LONG not null primary key,designationName VARCHAR(75) null,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null)";

	public static final String TABLE_SQL_DROP = "drop table AIXTOR_Designation";

	public static final String ORDER_BY_JPQL =
		" ORDER BY designation.designationId ASC";

	public static final String ORDER_BY_SQL =
		" ORDER BY AIXTOR_Designation.designationId ASC";
	...
	static {
		...
		attributeSetterBiConsumers.put(
			"designationName",
			(BiConsumer<Designation, String>)Designation::setDesignationName);
	...
	public int compareTo(Designation designation) {
		...
		if (getDesignationId() < designation.getDesignationId()) {
			value = -1;
		}
		else if (getDesignationId() > designation.getDesignationId()) {
			value = 1;
		}
		else {
			value = 0;
